...
function toggleCombatMenu(menuName) {
    const menuDiv = document.getElementById('combat-submenu-items');
    if (!menuDiv) return;
    
    if (activeCombatSubMenu === menuName) {
        activeCombatSubMenu = null;
...
function switchCombatItemTab(tabName) {
...
function renderCombatItemGrid() {
    const grid = document.getElementById('combat-item-grid');
    if (!grid) return;
