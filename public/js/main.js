...
// === NEW: POP-UP TUTORIAL MODULE ===
const tutorialSteps = [
    { title: "🛡️ The Knight's Profile", text: "Welcome to the Tavern! On the left side of your screen, you will see your Knight's core stats, your Equipped War Loadout, and your Backpack. Everything you carry into battle lives here." },
    { title: "⚒️ Town Idle Actions", text: "On the right is the Town screen. You can assign your Knight an Idle Job here. This allows you to passively gather resources or regenerate health while you manage your inventory." },
    { title: "🧺 Workers & Production", text: "Scroll down to hire Woodcutters, Fishermen, and Farmers. They work in the background to automatically fill your Supply Cart. Don't forget to claim it when it's full!" },
    { title: "🍻 Vaults & Shops", text: "Running out of space? Store items in the Grand Town Vault via the button on the left. Need supplies? Head into the Tavern (via the green button on the right) to craft Keg Bombs or brew Combat Stouts." },
    { title: "🗺️ Adventure Board", text: "Ready for action? Click on the red 'View Combat Adventures' button at the bottom right to open the Adventure Board. Here you can see what adventures are available to you and deploy your Knight!" },
    { title: "⚔️ Combat: Moving", text: "When you Deploy to the Wilds, combat is Turn-Based. During Phase 1 and Phase 3 of your turn, click a highlighted green tile to move your Knight across the tactical grid." },
    { title: "🎯 Combat: Attacking", text: "Phase 2 is the Action Phase! Click an enemy within your weapon's range to target them, then click your 'Standard Attack' or 'Weapon Skill' buttons to strike." },
    { title: "🧠 Combat: Intel", text: "Hover your mouse over any enemy on the grid at any time to inspect their health, damage, and strike radius. The enemies take their turn after your Phase 3. Good luck, Knight!" }
];
...
function renderTutorialStep() {
    ...
    document.getElementById('tutorial-title').innerHTML = tutorialSteps[currentTutorialStep].title;
    document.getElementById('tutorial-text').innerHTML = tutorialSteps[currentTutorialStep].text;
    
    const btn = document.getElementById('tutorial-next-btn');
    if (currentTutorialStep === tutorialSteps.length - 1) {
        btn.innerText = "Finish Tutorial ✔️";
