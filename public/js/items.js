...
const ItemDatabase = {
    ...
    "hunter_bow": {
        ...
        rarity: "Common", offense: 12, attackRange: 5, value: 75, spriteId: "weap_bow",
    ...
    "bone_fetch_club": { 
        ...
        offense: 60, attackRange: 1, value: 500, spriteId: "weap_bone",
        combat: {
    ...
    "rusty_mace": { 
        ...
        offense: 2, attackRange: 1, value: 15, spriteId: "weap_rusty_mace", // <--- Converted to Offense
        combat: {
            standard: { range: 1, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
    ...
    "behemoth_maw_crusher": { 
        ...
        offense: 55, attackRange: 1, value: 450, spriteId: "weap_behemoth_maw",
        combat: {
            standard: { range: 1, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
            special: { name: "Heavy Smash", range: 1, staminaCost: 15, multiplier: 1.5, ignoresResilience: false, desc: "Converts weight momentum into a heavy attack producing 1.5x standard power." }
        }
    ...
    "scavenged_machete": { 
        ...
        offense: 14, attackRange: 1, value: 25, spriteId: "weap_machete",
        combat: {
            standard: { range: 1, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
    ...
    "hunters_spear": { 
        ...
        offense: 8, attackRange: 2, value: 40, spriteId: "weap_spear",
        combat: {
    ...
    "boar_hide_armor": { id: "boar_hide_armor", name: "Boar-Hide Cuirass", slot: "armor", rarity: "Common", defense: 6, value: 30, spriteId: "armor_boar_hide" },
    "poachers_grips": { id: "poachers_grips", name: "Poacher's Grips", slot: "gloves", rarity: "Rare", offense: 6, value: 35, spriteId: "poachers_grips" },
    "wilderness_cloak": { id: "wilderness_cloak", name: "Wilderness Cloak", slot: "helmet", rarity: "Rare", defense: 12, value: 40, spriteId: "wilderness_cloak" },
	
    // === CELLAR TIER GEAR ===
    "oak_barrel_cuirass": { id: "oak_barrel_cuirass", name: "Oak Barrel Cuirass", slot: "armor", rarity: "Epic", defense: 15, value: 120, spriteId: "armor_oak_barrel" },
    "mimic_fang_dagger": { 
        id: "mimic_fang_dagger", name: "Mimic Fang Dagger", slot: "weapon", type: "Sword", rarity: "Epic", 
        offense: 20, attackRange: 1, value: 150, spriteId: "weap_mimic_dagger",
        combat: {
            standard: { range: 1, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
            special: { name: "Flurry", range: 1, staminaCost: 15, multiplier: 1.2, ignoresResilience: false, desc: "Strike rapidly targeting weak structural thresholds for 1.2x weapon value." }
        }
    ...
    "brewmasters_club": { 
        ...
        offense: 25, attackRange: 1, value: 120, spriteId: "brewmasters_club",
        combat: {
            standard: { range: 1, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
            special: { name: "Heavy Smash", range: 1, staminaCost: 15, multiplier: 1.5, ignoresResilience: false, desc: "Converts weight momentum into a heavy attack producing 1.5x standard power." }
        }
    ...
    "silverback_greatclub": { 
        ...
        offense: 450, attackRange: 2, value: 500, spriteId: "silverback_greatclub",
        combat: {
            standard: { range: 2, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
    ...
    "primate_armor": { id: "primate_armor", name: "🍌 Primate-Armor Skullplate", slot: "helmet", rarity: "Gorilla", defense: 75, value: 500, spriteId: "primate_armor" },
	
    // === THE PUBSERKER SET (Warrior / Balanced Brawler - Rare) ===
    "pubserker_flatcap": { id: "pubserker_flatcap", name: "Pubserker's Flatcap", slot: "helmet", rarity: "Rare", defense: 15, value: 50, spriteId: "helm_pubserker" },
    "pubserker_suspenders": { id: "pubserker_suspenders", name: "Pubserker's Suspenders", slot: "armor", rarity: "Rare", defense: 20, value: 75, spriteId: "armor_pubserker" },
    "pubserker_knuckles": { 
        id: "pubserker_knuckles", name: "Pubserker Brass Knuckles", slot: "weapon", type: "Club", rarity: "Rare", 
        offense: 22, attackRange: 1, value: 100, spriteId: "weap_knuckles",
        combat: {
            standard: { range: 1, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
            special: { name: "Heavy Smash", range: 1, staminaCost: 15, multiplier: 1.5, ignoresResilience: false, desc: "Converts weight momentum into a heavy attack producing 1.5x standard power." }
        }
    ...
    "beerglass_cuirass": { id: "beerglass_cuirass", name: "Beerglass Cuirass", slot: "armor", rarity: "Epic", defense: 10, value: 120, spriteId: "armor_beerglass" }, 
    "beerglass_shiv": { 
        id: "beerglass_shiv", name: "Jagged Beerglass Shiv", slot: "weapon", type: "Sword", rarity: "Epic", 
        offense: 45, attackRange: 1, value: 150, spriteId: "weap_beerglass",
        combat: {
            standard: { range: 1, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
            special: { name: "Flurry", range: 1, staminaCost: 15, multiplier: 1.2, ignoresResilience: false, desc: "Strike rapidly targeting weak structural thresholds for 1.2x weapon value." }
        }
    ...
    "tankard_plating": { id: "tankard_plating", name: "Tankard Oak Plating", slot: "armor", rarity: "Epic", defense: 45, value: 150, spriteId: "armor_tankard" }, 
    "tankard_maul": { 
        id: "tankard_maul", name: "Iron-Banded Tankard Maul", slot: "weapon", type: "Mace", rarity: "Epic", 
        offense: 15, attackRange: 1, value: 120, spriteId: "weap_tankard",
        combat: {
            standard: { range: 1, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
            special: { name: "Heavy Smash", range: 1, staminaCost: 15, multiplier: 1.5, ignoresResilience: false, desc: "Converts weight momentum into a heavy attack producing 1.5x standard power." }
        }
    ...
    "blackout_blinders": { id: "blackout_blinders", name: "Blackout Blinders", slot: "helmet", rarity: "Relic", defense: 25, value: 2500, spriteId: "helm_blackout" },
    "blackout_trench": { id: "blackout_trench", name: "Bouncer's Blackout Trench", slot: "armor", rarity: "Relic", defense: 45, value: 3500, spriteId: "armor_blackout" },
    "blackout_axe": { 
        id: "blackout_axe", name: "Void-Forged Keg-Splitter", slot: "weapon", type: "Axe", rarity: "Relic", 
        offense: 145, attackRange: 1, value: 5000, spriteId: "weap_blackout",
        combat: {
            standard: { range: 1, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
...
// === NEW: TARGETING BEHAVIORS ===
    ...
    "axe_timberlord": { 
        ...
        offense: 95, attackRange: 1, value: 800, spriteId: "weap_timberlord",
        combat: {
            standard: { range: 1, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
            special: { name: "Execute", range: 1, staminaCost: 15, multiplier: 1.5, ignoresResilience: false, desc: "Brings down a devastating vertical chop producing 1.5x standard power." }
        }
    ...
    "heartwood_cuirass": { id: "heartwood_cuirass", name: "Heartwood Cuirass", slot: "armor", rarity: "Epic", defense: 22, value: 160, spriteId: "heartwood_cuirass" },
    "heartwood_crown": { id: "heartwood_crown", name: "Heartwood Crown", slot: "helmet", rarity: "Relic", defense: 35, value: 1200, spriteId: "heartwood_crown" },
    ...
    "abyssal_diving_suit": { id: "abyssal_diving_suit", name: "Abyssal Diving Suit", slot: "armor", rarity: "Epic", defense: 25, value: 180, spriteId: "abyssal_diving_suit" },
    "abyssal_lantern": { id: "abyssal_lantern", name: "Lantern of the Deep", slot: "helmet", rarity: "Relic", defense: 30, value: 1300, spriteId: "abyssal_lantern" },
    ...
    "burlap_sack_mask": { id: "burlap_sack_mask", name: "Scarecrow's Sack", slot: "helmet", rarity: "Epic", defense: 18, value: 140, spriteId: "burlap_sack_mask" },
    "scythe_of_reaping": { 
        id: "scythe_of_reaping", name: "Scythe of Reaping", slot: "weapon", type: "Axe", rarity: "Relic", 
        offense: 115, attackRange: 2, value: 1600, spriteId: "scythe_of_reaping",
        combat: {
            standard: { range: 2, staminaCost: 5, multiplier: 1.0, animType: "lunge_bash" },
            special: { 
                name: "Scythe Spin", 
